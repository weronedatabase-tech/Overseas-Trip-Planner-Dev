...
document.getElementById('modalContainer').innerHTML = `
  ...
  <div id="selectionBottomSheet" class="fixed inset-0 bg-black/60 z-[95] hidden-force flex flex-col justify-end">
    <div class="bg-white dark:bg-gray-800 rounded-t-3xl w-full max-w-md mx-auto overflow-hidden shadow-2xl animate-slide-up border-t border-gray-200 dark:border-gray-700 h-[80vh] flex flex-col">
      ...
      <div class="p-3 bg-gray-50 dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 shrink-0">
        <input type="text" id="pairingSearchInput" oninput="filterPairingSheet()" placeholder="Search by name..." class="w-full p-2.5 border rounded-lg bg-white dark:bg-gray-800 font-medium text-sm focus:outline-none focus:border-primary text-gray-900 dark:text-white shadow-sm">
      </div>
