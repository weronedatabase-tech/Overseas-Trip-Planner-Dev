const allParticipants = [
    ...
    { nric: 'B', role: 'CAREGIVER', relatedTrainee: 'T1', pocNric: 'A' },
    { nric: 'T1', role: 'TRAINEE', fullName: 'T1', relatedTrainee: '', pocNric: 'A' }
];
...
console.log("For A", window.getFamilyMembers('A', allParticipants));
console.log("For B", window.getFamilyMembers('B', allParticipants));
console.log("For T1", window.getFamilyMembers('T1', allParticipants));
