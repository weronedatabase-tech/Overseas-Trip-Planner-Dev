...
function buildFilesUI() {
   ...
   <div class="flex flex-col h-full w-full relative">
       <div class="bg-white dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800 p-2 md:p-3 shrink-0 flex items-center gap-2 shadow-sm rounded-t-xl md:rounded-none relative z-20">
           <button type="button" id="btnDriveBack" onclick="navigateDriveBack()" class="hidden-force p-1.5 rounded-lg text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition focus:outline-none shrink-0 active:scale-95">
           ...
           <h3 id="driveCurrentFolderName" class="text-sm md:text-base font-black text-zinc-900 dark:text-white tracking-tight truncate flex-1 min-w-0 pr-1">Trip Folder</h3>
           ...
           <div class="flex items-center gap-1 md:gap-1.5 shrink-0">
               ...
               <button type="button" id="btnDrivePaste" onclick="pasteFromDriveClipboard()" class="hidden-force p-1.5 rounded-lg text-green-600 hover:bg-green-50 dark:hover:bg-zinc-800 transition focus:outline-none shrink-0 flex items-center gap-1 font-bold text-xs md:text-sm active:scale-95" title="Paste Item">
               ...
               <div class="relative inline-block text-left z-30">
                   <button type="button" id="btnDriveAdd" onclick="toggleDriveAddMenu(event)" class="p-1.5 rounded-lg text-primary hover:bg-blue-50 dark:hover:bg-zinc-800 transition focus:outline-none shrink-0 flex items-center gap-1 font-bold text-xs md:text-sm active:scale-95" title="Add New">
                   ...
                   <div id="driveAddMenu" class="hidden-force origin-top-right absolute right-0 mt-2 w-56 rounded-xl shadow-2xl bg-white dark:bg-zinc-800 border border-zinc-100 dark:border-zinc-700 ring-1 ring-black ring-opacity-5 divide-y divide-zinc-100 dark:divide-zinc-700 z-[100]">
                       <div class="py-1.5">
                           <a href="#" onclick="toggleDriveAddMenu(); promptCreateFolder()" class="group flex items-center px-4 py-2 text-sm font-bold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"><svg class="mr-3 h-5 w-5 text-yellow-500 pointer-events-none" fill="currentColor" viewBox="0 0 24 24"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg> New Folder</a>
                           <a href="#" onclick="toggleDriveAddMenu(); triggerFileUpload()" class="group flex items-center px-4 py-2 text-sm font-bold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"><svg class="mr-3 h-5 w-5 text-blue-500 pointer-events-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12" /></svg> File Upload</a>
                       </div>
                       <div class="py-1.5">
                           <a href="#" onclick="toggleDriveAddMenu(); promptCreateGoogleDoc('doc')" class="group flex items-center px-4 py-2 text-sm font-bold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"><svg class="mr-3 h-5 w-5 text-blue-600 pointer-events-none" fill="currentColor" viewBox="0 0 24 24"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg> Google Doc</a>
                           <a href="#" onclick="toggleDriveAddMenu(); promptCreateGoogleDoc('sheet')" class="group flex items-center px-4 py-2 text-sm font-bold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"><svg class="mr-3 h-5 w-5 text-green-600 pointer-events-none" fill="currentColor" viewBox="0 0 24 24"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg> Google Sheet</a>
                           <a href="#" onclick="toggleDriveAddMenu(); promptCreateGoogleDoc('slide')" class="group flex items-center px-4 py-2 text-sm font-bold text-zinc-700 dark:text-zinc-200 hover:bg-zinc-50 dark:hover:bg-zinc-700/50 transition-colors"><svg class="mr-3 h-5 w-5 text-yellow-600 pointer-events-none" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM10 8v8l6-4z"/></svg> Google Slides</a>
                       </div>
                   </div>
               </div>
               
               <button type="button" onclick="refreshCurrentDriveFolder(this)" class="p-1.5 rounded-lg text-primary hover:bg-blue-50 dark:hover:bg-zinc-800 transition focus:outline-none shrink-0 relative z-30 flex items-center justify-center active:scale-95" title="Refresh">
       ...
       <div id="driveBulkActions" class="hidden-force bg-blue-50 dark:bg-blue-900/30 p-2 md:p-3 shrink-0 flex justify-between items-center border-b border-blue-200 dark:border-blue-800 z-10 transition-all">
           ...
           <div class="flex items-center gap-1.5 md:gap-2">
               <button onclick="bulkCopySelected()" class="px-2 py-1.5 text-[10px] md:text-xs font-bold bg-white dark:bg-zinc-800 text-blue-700 dark:text-blue-400 border border-blue-200 dark:border-blue-700 rounded shadow-sm hover:bg-blue-100 transition focus:outline-none">Copy</button>
               <button onclick="bulkMoveSelected()" class="px-2 py-1.5 text-[10px] md:text-xs font-bold bg-white dark:bg-zinc-800 text-orange-600 dark:text-orange-400 border border-orange-200 dark:border-orange-800 rounded shadow-sm hover:bg-orange-50 transition focus:outline-none">Move</button>
               <button onclick="bulkDeleteSelected()" class="px-2 py-1.5 text-[10px] md:text-xs font-bold bg-white dark:bg-zinc-800 text-red-600 dark:text-red-400 border border-red-200 dark:border-red-800 rounded shadow-sm hover:bg-red-50 transition focus:outline-none">Delete</button>
               <button onclick="clearDriveSelection()" class="px-2 py-1.5 text-[10px] md:text-xs font-bold bg-white dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 border border-zinc-300 dark:border-zinc-600 rounded shadow-sm hover:bg-zinc-100 transition focus:outline-none ml-2">Cancel</button>
           </div>
       </div>

       <div id="driveLoadingOverlay" class="absolute inset-0 bg-white/60 dark:bg-zinc-950/60 backdrop-blur-sm z-[50] hidden-force flex flex-col justify-center items-center">
           <div class="loader !w-8 !h-8 border-primary mb-2"></div>
           <span id="driveLoadingText" class="text-primary dark:text-blue-400 font-bold text-[10px] tracking-wide shadow-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 px-3 py-1 rounded-full mt-2">Loading folder...</span>
       </div>

       <div id="driveContentsList" class="flex-grow overflow-y-auto p-2 md:p-3 space-y-1.5 bg-zinc-50 dark:bg-zinc-950 custom-scrollbar pb-10"></div>
   </div>
   `;
...
function renderDriveContents(folders, files) {
   ...
   folders.forEach(f => {
       ...
       html += `
       <div class="flex items-center gap-1 bg-white dark:bg-zinc-800 p-1 md:p-1.5 rounded-lg border border-zinc-200 dark:border-zinc-700 shadow-sm hover:border-primary transition group">
           ...
           <div onclick="loadDriveFolder('${f.id}', '${safeName}')" class="flex items-center gap-3 flex-1 min-w-0 cursor-pointer select-none active:scale-[0.98] px-2 py-1">
               ...
               <span class="font-bold text-sm text-zinc-900 dark:text-white truncate group-hover:text-primary transition-colors">${f.name}</span>
           </div>
           <div class="flex items-center gap-0.5 shrink-0 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
               <button onclick="actionSingleCopy('${f.id}', true, '${safeName}')" class="p-2 text-zinc-400 hover:text-green-500 hover:bg-green-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Copy Folder">${copyIcon}</button>
               <button onclick="actionSingleMove('${f.id}', true, '${safeName}')" class="p-2 text-zinc-400 hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Move Folder">${moveIcon}</button>
               <button onclick="promptRenameDriveItem('${f.id}', true, '${safeName}')" class="p-2 text-zinc-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Rename Folder">${pencilIcon}</button>
               <button onclick="promptDeleteDriveItem('${f.id}', true, '${safeName}')" class="p-2 text-zinc-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Delete Folder">${trashIcon}</button>
           </div>
       </div>
       `;
   });
   ...
   files.forEach(f => {
       const safeName = f.name.replace(/'/g, "\\'");
       const isChecked = selectedDriveItems.has(f.id) ? 'checked' : '';
       let iconHtml = '', bgClass = 'bg-zinc-50 dark:bg-zinc-700';

       if (f.mimeType.includes('folder')) { bgClass = 'bg-yellow-50 dark:bg-yellow-900/30'; iconHtml = `<svg class="w-5 h-5 text-yellow-600 dark:text-yellow-400" viewBox="0 0 24 24" fill="currentColor"><path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z"/></svg>`; } 
       else if (f.mimeType.includes('spreadsheet')) { bgClass = 'bg-green-50 dark:bg-green-900/30'; iconHtml = `<svg class="w-5 h-5 text-green-600 dark:text-green-400" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>`; } 
       else if (f.mimeType.includes('document')) { bgClass = 'bg-blue-50 dark:bg-blue-900/30'; iconHtml = `<svg class="w-5 h-5 text-blue-600 dark:text-blue-400" viewBox="0 0 24 24" fill="currentColor"><path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/></svg>`; } 
       else if (f.mimeType.includes('presentation')) { bgClass = 'bg-yellow-50 dark:bg-yellow-900/30'; iconHtml = `<svg class="w-5 h-5 text-yellow-600 dark:text-yellow-400" viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14zM10 8v8l6-4z"/></svg>`; } 
       else if (f.mimeType.includes('pdf')) { bgClass = 'bg-red-50 dark:bg-red-900/30'; iconHtml = `<svg class="w-5 h-5 text-red-600 dark:text-red-400" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8.5 7.5c0 .83-.67 1.5-1.5 1.5H9v2H7.5V7H10c.83 0 1.5.67 1.5 1.5v1zm5 2c0 .83-.67 1.5-1.5 1.5h-2.5V7H15c.83 0 1.5.67 1.5 1.5v3zm4-3H19v1h1.5V11H19v2h-1.5V7h3v1.5zM9 9.5h1v-1H9v1zM16.5 9h-1v2h1V9z"/><path d="M4 6H2v14c0 1.1.9 2 2 2h14v-2H4V6z"/></svg>`; } 
       else { iconHtml = `<svg class="w-5 h-5 text-zinc-500 dark:text-zinc-400" viewBox="0 0 24 24" fill="currentColor"><path d="M6 2c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6H6zm6 1.5L18.5 9H12V3.5z"/></svg>`; }

       const shortcutBadge = f.isShortcut ? `<div class="absolute -bottom-1 -right-1 bg-white dark:bg-zinc-800 rounded-full shadow-sm p-0.5"><svg class="w-3 h-3 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" /></svg></div>` : '';
       const nameHtml = f.isShortcut 
         ? `<div class="flex flex-col min-w-0"><span class="font-bold text-sm text-zinc-900 dark:text-white truncate group-hover:text-primary transition-colors">${f.name}</span><span class="text-[9px] text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-black">Shortcut</span></div>`
         : `<span class="font-bold text-sm text-zinc-900 dark:text-white truncate group-hover:text-primary transition-colors">${f.name}</span>`;

       html += `
       <div class="flex items-center gap-1 bg-white dark:bg-zinc-800 p-1 md:p-1.5 rounded-lg border border-zinc-200 dark:border-zinc-700 shadow-sm hover:border-zinc-300 dark:hover:border-zinc-500 transition group">
           <div class="flex items-center pl-2 shrink-0" onclick="event.stopPropagation()">
           ...
           <div class="flex items-center gap-0.5 shrink-0 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
               <button onclick="actionSingleCopy('${f.id}', false, '${safeName}')" class="p-2 text-zinc-400 hover:text-green-500 hover:bg-green-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Copy File">${copyIcon}</button>
               <button onclick="actionSingleMove('${f.id}', false, '${safeName}')" class="p-2 text-zinc-400 hover:text-orange-500 hover:bg-orange-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Move File">${moveIcon}</button>
               <button onclick="promptRenameDriveItem('${f.id}', false, '${safeName}')" class="p-2 text-zinc-400 hover:text-blue-500 hover:bg-blue-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Rename File">${pencilIcon}</button>
               <button onclick="promptDeleteDriveItem('${f.id}', false, '${safeName}')" class="p-2 text-zinc-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-zinc-700 rounded-md transition focus:outline-none shrink-0" title="Delete File">${trashIcon}</button>
           </div>
       </div>
       `;
   });
