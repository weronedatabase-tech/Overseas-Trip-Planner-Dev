...
async function loadProfileData() {
   ...
   <div id="profileCardsContainer" class="space-y-3">
       <div class="absolute inset-0 bg-white/60 dark:bg-zinc-950/60 backdrop-blur-sm z-20 flex flex-col justify-center items-center">
           <div class="loader !w-8 !h-8 border-primary mb-2"></div>
           <span class="text-primary dark:text-blue-400 font-bold text-[10px] tracking-wide shadow-sm bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 px-3 py-1 rounded-full">Loading Profile...</span>
       </div>
   </div>
   `;
