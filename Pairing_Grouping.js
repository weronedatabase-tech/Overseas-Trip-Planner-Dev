...
function openPairingSheet(traineeNric) {
 ...
 // Generate dynamically colored Trainee title tag
 ...
 if (targetTrainee) {
   ...
   titleHtml = `Pair Volunteer with <span class="ml-2 font-bold text-sm px-2 py-0.5 rounded border ${dynColor}">${targetTrainee.name}</span>`;
 }
